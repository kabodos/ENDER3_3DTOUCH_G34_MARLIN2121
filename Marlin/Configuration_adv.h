...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 300  //tt estaba desactivado
   ...
   */
  #define BLTOUCH_HS_MODE true  //tt estaba desactivado
 ...
 */
#define Z_STEPPER_AUTO_ALIGN //tt estaba desactivado
 ...
 */
#define INPUT_SHAPING_X //tt
#define INPUT_SHAPING_Y //tt
  ...
  #endif
  #define SHAPING_MIN_FREQ  20  //tt estaban comentadas      // By default the minimum of the shaping frequencies. Override to affect SRAM usage.
  #define SHAPING_MAX_STEPRATE 5000 //tt estaban comentadas // By default the maximum total step rate of the shaped axes. Override to affect SRAM usage.
  #define SHAPING_MENU //tt               // Add a menu to the LCD to set shaping parameters.
#endif
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD   //3dtouch    // Add a Probe Z Offset calibration option to the LCD menu
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -4.0 //3dtouch
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       410        // (mA) RMS current. Multiply by 1.414 for peak current.
    ...
    #define Z2_CURRENT      410 //tt tenia 800
